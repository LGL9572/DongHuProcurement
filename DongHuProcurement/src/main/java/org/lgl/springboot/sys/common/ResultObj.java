...
public class ResultObj {
    ...
    public static final ResultObj DISPATCH_EPPOR = new ResultObj(Constast.ERROR,"分配失败");

    public static final ResultObj OPERATE_SUCCESS = new ResultObj(Constast.OK,"操作成功");
    public static final ResultObj OPERATE_EPPOR = new ResultObj(Constast.ERROR,"操作失败");
